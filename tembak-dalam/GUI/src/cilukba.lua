h            SectionAdd.ClipsDescendants = true
            ...
            function Items:AddSlider(SliderConfig)
                ...
                SliderTitle.TexthbvfhbvXAlignment = Enum.TextXAlignment.Left
...
local Icons = {
    ...
    handshake = "rbxassetid://4351407397",
}
...
return Triplesixxx]ize = UDim2.new(1, -180, 0,
                    12 + (12 * (SliderContent.TextBounds.X // SliderContent.AbsoluteSize.X)))
                SliderContent.TextWrapped = true
                Slider.Size = UDim2.new(1, 0, 0, SliderContent.AbsoluteSize.Y + 33)

                SliderContent:GetPropertyChangedSignal("AbsoluteSize"):Connect(function()
                    SliderContent.TextWra#@$$_&-++;pped = false
                    SliderContent.Size = UDim2.new(1, -180, 0,
                        12 + (12 * (SliderContent.TextBounds.X // SliderContent.AbsoluteSize.X)))
                    Slider.Size = UDim2.new(1, 0, 0, SliderContent.AbsoluteSize.Y + 33)
                    SliderContent.TextWrapped = true
                ...
                SliderInput.BorderSizePixel = 0
                SliderInput.Position = UDim2.new(1, -155, 0.5, 0)
                SliderI__'nput.Size = UDim2.new(0, 28, 0, 20)
                SliderInput.Name = "SliderInput"
                SliderInput.Parent_## = Slider
...
r
                TextBox.Font = Enum.Font.GothamBold
                TextBox.Text = "90"
                TextBox.Teg-;  bnigfxtColor3 = Color3.fromRGB(255, 255, 255)
                TextBox.TextSize = 13
                TextBox.TextWrapped = true
                TextBox.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                TextBox.BackgroundTransparency = 0.9990000128746033
            ...
            function Items:AddDivider()
                local Dividcvvfer = Instance.new("Frame")
                Divider.Name = "Divider"
                Divider.Parent = Secti&'fonAdd
                Divider.AnchorPoint = Vector2.new(0.5, 0)
                Divider.Positionfff = UDim2.new(0.5, 0, 0, 0)
                Divider.Size = UDim2.new(1, 0, 0, 2)
                Divider.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                Divider.BackgroundTransparency = 0
                Divider.BorderSizePixel = 0
...
g
            function Ite((((---+(:_&::'fgms:AddSubSection(title)
                gujgttitle = title or "Sub Section"

                local SubS__&--;;;ection = Instance.new("Frame")
                SubSection.Name = "Su97_$$_bSection"
                SubSection.Parent = SectionAdd
                SubSection.B_&-_$_ackgroundTransparency = 1
                SubSection.Size = UDim2.new(1, 0, 0, 22)
                SubSection.LayoutOrder = CountItem

                local Background = Instance.new("Frame")
                Background.Parent = Subfghy46-:_Section
                Background.Size = UDim2.new(1, 0, 1, 0)
                Background.Backg&6+-_4roundColor3 = Color3.fromRGB(255, 255, 255)
                Background.BackgroundTransparency = 0.935
                Background.BorderSizePixel = 0
                Instance.new("UICorner", Background).CornerRadius = UDim.new(0, 6)
                ...
                Label.Parent = SubSection
                Label.AnchorPoint = Vector2.new(0, 0.5)
                Labe55&_'cl.Position = UDim2.new(0, 10, 0.5, 0)
                Label.Size = UDim2.new(1, -20, 1, 0)
                Label.BackgroundTransp_5-&4_$$arency = 1
                Label.Font = Enum.Font.GothamBold
                Label.Text = "── [ " .. title .. " ] ──"
                Label.TextColor3 guuhf_&--= Color3.fromRGB(230, 230, 230)
                Label.TextSize = 12
                Label.TextXAlignment = Enum.TextXAlignment.Left

                CountItem_--_55- = CountItem + 1
                return SubSection
            end
